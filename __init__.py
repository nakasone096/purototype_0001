...
REFERENCE_IMAGE_FILENAME = "公式絵_SP_カービィ"
REFERENCE_IMAGE_LOCATION  = (1.50686, 2.37497, 0.0)
REFERENCE_IMAGE_ROTATION_DEG = (65.5268, -0.000009, 68.1696)
    ...
    def validate_stage(context):
        ...
        if ch == 7:
            ...
            return False, "❌ まだ保存が検出できません", "RENDER_NOT_SAVED", [
                "F12 キーを押してレンダリングを実行してください",
                "レンダー結果の画面で「画像」→「名前をつけて保存」を選んでください",
                "または下の「補助: レンダーして保存（自動）」ボタンでも保存できます",
            ]
